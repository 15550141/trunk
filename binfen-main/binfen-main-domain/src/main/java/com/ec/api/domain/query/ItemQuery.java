...
public class ItemQuery extends BaseSearchForMysqlVo implements Serializable{
     ...
     * 是否有检测报告
     */
    private int ifHaveZjbg;
    /**
     * 是否有产品认证
     */
    private int ifHaveCprz;
    /**
     * 上市开始时间
     */
	...
	public int getIfHaveZjbg() {
		return ifHaveZjbg;
	}

	public void setIfHaveZjbg(int ifHaveZjbg) {
		this.ifHaveZjbg = ifHaveZjbg;
	}

	public int getIfHaveCprz() {
		return ifHaveCprz;
	}

	public void setIfHaveCprz(int ifHaveCprz) {
