...
u,"' title='' treeNode",u," onfocus='this.blur();' class='",Ua(a,f),"' style='",ya(a,f),"'></button><span id='",f.tId,fa,"'>",f[a.nameCol].replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),"</span></a><ul id='",f.tId,E,"' class='",a.showLine&&!f.isLastNode?ga:"z_line","' style='display:",f.open?"block":"none","'>");e.push(k.join(""));e.push("</ul></li>")}return e}function w(a){var b=a.target,c=a.relatedTarget,d=r[a.data.treeObjId],e="",g="",j="",f=null;if(i.eqs(a.type,"mouseover"))if(d.checkable&&
...
function S(a,b){if(b){var c=h("#"+b.tId+G),d=h("#"+b.tId+E),e=h("#"+b.tId+u),g=a.showLine&&!b.isLastNode?ga:"";g.length==0?d.removeClass(ga):d.addClass(g);c.attr("class",Ra(a,b));e.removeAttr("style");e.attr("style",ya(a,b));e.attr("class",Ua(a,b))}}function Ra(a,b){var c=["switch"];if(a.showLine)if(b.level==0&&b.isFirstNode&&b.isLastNode)c.push(Aa);else if(b.level==0&&b.isFirstNode)c.push(Ba);else b.isLastNode?c.push(ia):c.push(Wa);else c.push(Xa);b.isParent?c.push(b.open?N:O):c.push(P);return c.join("_")}
...
"="+b[a.asyncParam[c]];if(i.isArray(a.asyncParamOther)){c=0;for(d=a.asyncParamOther.length;c<d;c+=2)e+=(e.length>0?"&":"")+a.asyncParamOther[c]+"="+a.asyncParamOther[c+1]}else for(var g in a.asyncParamOther)e+=(e.length>0?"&":"")+g+"="+a.asyncParamOther[g];h.ajax({type:"POST",url:i.apply(a.asyncUrl,[b],a.asyncUrl),data:e,dataType:"text",success:function(j){var f=[];try{f=!j||j.length==0?[]:typeof j=="string"?eval("("+j+")"):j}catch(o){}if(b)b.isAjaxing=null;S(a,b);if(f&&f!=""){f=i.apply(a.asyncDataFilter,
...
b,c);ea(a,b.level+1,c,b);d||$(a,b,true)}}else{db(a,a.root,c);ea(a,0,c,null)}}}function db(a,b,c){b[a.nodesCol]||(b[a.nodesCol]=[]);if(b[a.nodesCol].length>0){b[a.nodesCol][b[a.nodesCol].length-1].isLastNode=false;S(a,b[a.nodesCol][b[a.nodesCol].length-1])}b.isParent=true;b[a.nodesCol]=b[a.nodesCol].concat(c)}function aa(a,b,c,d,e){if(b!=c)if(!(a.keepLeaf&&b&&!b.isParent&&d==t)){var g=c.parentNode==null?a.root:c.parentNode,j=b===null||b==a.root;if(j&&b===null)b=a.root;if(j)d=t;var f=b.parentNode?b.parentNode:
...
ba?f[a.nodesCol].splice(B,0,c):f[a.nodesCol].splice(B+1,0,c);c.parentNode=b.parentNode;c.isFirstNode=false;c.isLastNode=false}Pa(a,c);cb(a,c.parentNode,c);var la,ma;if(j)f=j=a.treeObj;else{j=h("#"+b.tId);la=h("#"+b.tId+G);ma=h("#"+b.tId+u);f=h("#"+b.tId+E)}if(d==t){H(la,N);W(b,ma,N);b.open=true;f.css({display:"block"});f.append(h("#"+c.tId).remove(null,true))}else if(d==ba)j.before(h("#"+c.tId).remove(null,true));else d==ka&&j.after(h("#"+c.tId).remove(null,true));S(a,c);if(!a.keepParent&&g[a.nodesCol].length<
1){g.isParent=false;b=h("#"+g.tId+E);d=h("#"+g.tId+G);n=h("#"+g.tId+u);H(d,P);W(g,n,P);b.css("display","none")}else n&&S(a,n);p&&S(a,p);if(a.checkable){bb(a,g);T(a,g);g!=c.parent&&T(a,c)}$(a,c.parentNode,true,e)}}function Pa(a,b){if(a.isSimpleData)b[a.treeNodeParentKey]=b.parentNode?b.parentNode[a.treeNodeKey]:a.rootPID}function Ca(a,b){var c=b.parentNode==null?a.root:b.parentNode;if(a.curTreeNode===b)a.curTreeNode=null;if(a.curEditTreeNode===b)a.curEditTreeNode=null;h("#"+b.tId).remove();delete J[a.treeObjId][b.tId];
...
updateNode:function(a,b){if(a)if(C.checkEvent(this.setting)){var c=h("#"+a.tId+x);if(this.setting.checkable){b==true&&Za(this.setting,a);L(this.setting,c,a);T(this.setting,a)}za(this.setting,a);h("#"+a.tId+q).attr("target",a.target||"_blank");var d=this.setting;c=h("#"+a.tId+q);d=a.url&&!d.editable?a.url:null;d==null||d.length==0?c.removeAttr("href"):c.attr("href",d);S(this.setting,a);d=this.setting;c=h("#"+a.tId+q);(d=Qa(d,a))&&c.css(d)}},moveNode:function(a,b,c){if(b)if(!(a&&(b.parentNode==a&&c==
t||h("#"+b.tId).find("#"+a.tId).length>0))){a||(a=null);aa(this.setting,a,b,c,false)}},copyNode:function(a,b,c){if(!b)return null;b=i.clone(b);if(!a){a=null;c=t}if(c==t)M(this.setting,a,[b]);else{M(this.setting,a.parentNode,[b]);aa(this.setting,a,b,c,false)}return b},removeNode:function(a){a&&Ca(this.setting,a)}}}var na="ZTREE_NODECREATED",oa="ZTREE_CLICK",pa="ZTREE_CHANGE",qa="ZTREE_RENAME",ra="ZTREE_REMOVE",sa="ZTREE_DRAG",da="ZTREE_DROP",ta="ZTREE_EXPAND",ua="ZTREE_COLLAPSE",va="ZTREE_ASYNC_SUCCESS",
wa="ZTREE_ASYNC_ERROR",G="_switch",u="_ico",fa="_span",V="_input",x="_check",Y="_edit",Z="_remove",E="_ul",q="_a",Aa="root",Ba="roots",Wa="center",ia="bottom",Xa="noLine",ga="z_line",N="open",O="close",P="docu",Ja="curSelectedNode",hb="curSelectedNode_Edit",U="radio",sb="chk",qb="false",pb="true",$a="full",ab="part",rb="focus",xa="all",t="inner",ba="before",ka="after",r=[],mb=0,J=[];h.fn.zTree=function(a,b){var c={treeObjId:"",treeObj:null,checkable:false,editable:false,edit_renameBtn:true,edit_removeBtn:true,
showLine:true,showIcon:true,keepParent:false,keepLeaf:false,curTreeNode:null,curEditTreeNode:null,dragStatus:0,dragNodeShowBefore:false,dragCopy:false,dragMove:true,checkStyle:"checkbox",checkType:{Y:"ps",N:"ps"},checkRadioType:"level",checkRadioCheckedList:[],async:false,asyncUrl:"",asyncParam:[],asyncParamOther:[],asyncDataFilter:null,isSimpleData:false,treeNodeKey:"",treeNodeParentKey:"",rootPID:null,nameCol:"name",nodesCol:"nodes",checkedCol:"checked",expandSpeed:"fast",expandTriggerFlag:false,
...
[b.treeObjId,a],true)==false)return;b.expandTriggerFlag=true;Fa(b,a)},onClickNode:function(a){var b=r[a.data.treeObjId];a=a.data.treeNode;if(i.apply(b.callback.beforeClick,[b.treeObjId,a],true)!=false){K(b,a);b.treeObj.trigger(oa,[b.treeObjId,a])}},onCheckNode:function(a){var b=r[a.data.treeObjId];a=a.data.treeNode;if(i.apply(b.callback.beforeChange,[b.treeObjId,a],true)!=false){a[b.checkedCol]=!a[b.checkedCol];Za(b,a);var c=h("#"+a.tId+x);L(b,c,a);T(b,a);b.treeObj.trigger(pa,[b.treeObjId,a])}},onMouseoverCheck:function(a){var b=
